...
This mindset actually requires its own course to be fully understood, so this module will really only act as the *bare-minimum* to understand it. You can just go off without having to understand this concept first (in fact, a ton of professionals adopted an anti-OOP philosophy for a while.) Yet, it's still important to *understand* this concept because *cough cough* [[4.9c - Checkpoint (Organizational Structures)]] 
